				...
				<div class="col-md-9">
					...
					<div class="col-md-9">
			 			<select class="form-control" name="isscheduled" id="isscheduled" required="required">							 				
			 				<option value="1" <?php if($r['isScheduled']==1){ echo 'selected="selected"';}?>>Scheduled</option>
			 				<option value="0" <?php if($r['isScheduled']==0){ echo 'selected="selected"';}?>>Unscheduled</option>
			 				<option value="2" <?php if($r['isScheduled']==2){ echo 'selected="selected"';}?>>Grid Outage</option>
			 			</select>
			 		</div>	
