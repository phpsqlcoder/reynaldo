											...
											$data.='<tr>
														...
														foreach(interval($_GET['startDate'],$_GET['endDate'],$_GET['datetype']) as $x){														
															...
															if($r['tmin']>0){
																...
																$bgcolor="background-color:#F91608;color:white;";
															}
															else{
																$bgcolor='background-color:green;color:black;';
																$mins='100%';
															}	
															$data.='<td style="'.$bgcolor.'" align="center"><a href="#" onclick="return false;" data-toggle="popover" title="'.$mins.'" data-content="'.$allremarks.'" data-trigger="hover" style="color:white;" data-placement="top">&nbsp;'.$mins.'</a></td>';
														}
											$data.='</tr>';
										}
									}
