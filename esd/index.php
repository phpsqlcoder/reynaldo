...
if(isset($_GET['act'])){
	if($_GET['act']=='submitdowntime'){
		$is_sched = $_POST['isscheduled'];
		$insert="insert into downtime (dateStart,dateEnd,remarks,addedBy,addedDate,unitId,isScheduled)
			VALUES('".$_POST['startd']."','".$_POST['endd']."','".$_POST['remarks']."','".$_SESSION['esd_username']."','".date('Y-m-d h:i:s')."','".$_POST['unit']."','".$is_sched."'); SELECT SCOPE_IDENTITY()";
			...
			<div class="row">				
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-intense" style="height:130px;">
						<div class="visual">
							<img src="images/FEEDER BREAKER.png" alt="" width="130" style="position:relative;top:-30px;">
						</div>
						<div class="details">
							<div class="number">
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze" style="height:130px;">
						...
						<a class="more pull-right margin-top-10" href="#">
						 View more&nbsp;&nbsp;<i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
