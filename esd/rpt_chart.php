...
if(isset($_GET['startdate'])){
	...
	//$tdata.='<tr><td colspan="4"><a class="btn green" href="rpt_chart_print.php?'.$_SERVER["QUERY_STRING"].'">Print</a></td></tr>';
}
//die();
?>
<html lang="en">
		...
		<div class="page-content">
				        ...
				        <table width="100%">
				            <tr>				              
				            	<td><select name="pl" style="font-style:Arial;font-size:14px;">
				            		...
				            		<option value="2" <?php echo $plg;?>> Grid Outage Only
				            		<option value="" <?php echo $pla;?>> All
				            	</select></td>	
			...
			<div class="row">
				<div class="col-md-12">
					...
					<table width="100%" style="font-style:Arial;font-size:12px;">
						<tr>
