...
if($_GET['isplanned']){
	if($_GET['isplanned']=='planned'){
		$cond.=" and d.isScheduled='1'";
	}
	if($_GET['isplanned']=='unplanned'){
		$cond.=" and d.isScheduled='0'";
	}
	if($_GET['isplanned']=='grid'){
		$cond.=" and d.isScheduled='2'";
	}
}
		...
		<div class="page-content">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							...
							<select class="form-control input-sm" name="isplanned">
				 				<option value="ALL" <?php if ($_GET['isplanned']=='ALL' OR $_GET['isplanned']=='') echo 'selected="selected"';?>> - ALL -
				 				<option value="planned" <?php if ($_GET['isplanned']=='planned') echo 'selected="selected"';?>> PLANNED
				 				<option value="unplanned" <?php if ($_GET['isplanned']=='unplanned') echo 'selected="selected"';?>> BREAKDOWN
				 				<option value="grid" <?php if ($_GET['isplanned']=='grid') echo 'selected="selected"';?>> GRID OUTAGE
			...
			<div class="row ">
				<div class="col-md-12 col-sm-12">
									...
									<?php 
										$ldata='';
										$lt=sqlsrv_query($conn,"select count(d.id) as totald from genset_utilization d");
										$seq=$lt['totald'];
										$seq=0;
										$lq=sqlsrv_query($conn,"select CONVERT(VARCHAR(19),d.dateStart) as ds,CONVERT(VARCHAR(19),d.dateEnd) as de,d.*,u.name as uni from genset_utilization d 
