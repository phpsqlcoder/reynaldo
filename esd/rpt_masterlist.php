		...
		<div class="page-content">		
			...
			<div class="row">
				...
				<?php if(isset($_GET['act'])=="generate"){  ?>
					<a class="btn btn-success btn-xs" onclick="exportToExcel('#table1');">Export<span class="fa fa-excel"></span></a><br><br>
...
<script>
	function exportToExcel(table){
		jQuery(table).table2excel({
			name: "Worksheet Name",
		    filename: "ESD_MASTERLIST" //do not include extension
		}); 
	}
</script>
