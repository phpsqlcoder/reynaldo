				...
				<div class="col-md-12">
					<table width="100%" style="font-style:Arial;font-size:14px;">
									...
									<tr><td colspan="3"><a class="btn green" href="rpt_flatdata.php?isexcel=1&<?php echo $_SERVER['QUERY_STRING'];?>">Export to Excel</a>
										&nbsp;<a class="btn purple" onclick="window.open('rpt_flatdata_print.php?isexcel=1&<?php echo $_SERVER['QUERY_STRING'];?>')" href="#">Print</a>
										&nbsp;<a class="btn red" target="_blank" href="rpt_chart.php?isexcel=1&<?php echo $_SERVER['QUERY_STRING'];?>">Forward to Pareto Report</a>
									</td>
